...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--red", choices=("random", "search"), default="random")
    parser.add_argument("--black", choices=("random", "search"), default="random")
...
def _agent_factory(name: str, depth: int, node_budget: int) -> AgentFactory:
    if name == "random":
        return RandomAgent
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        red_factory = _agent_factory(args.red, args.search_depth, args.node_budget)
        black_factory = _agent_factory(args.black, args.search_depth, args.node_budget)
